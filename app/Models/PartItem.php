...
class PartItem extends Model
{
    ...
    public function imagepath()
    {
        ...
        if ($val && file_exists(storage_path('/app/public/img/part/' . $val))) {
            return storage_path('/app/public/img/part/' . $val);
        } else {
    ...
    {
        if ($value && file_exists(storage_path('/app/public/img/part/' . $value))) {
            return asset('storage/img/part/' . $value);
        } else {
